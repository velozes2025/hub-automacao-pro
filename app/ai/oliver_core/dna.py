...
DNA_TEMPLATE = (
    ...
    'MSG:Converse como humano no WhatsApp. Maioria das respostas: 1-2 frases curtas e diretas. '
    'So escreva mais quando o assunto exigir. NUNCA repita o que ja disse. '
    'Se ja explicou automacao, NAO explique de novo — AVANCE para o proximo passo. '
    'Perguntas curtas. Respostas objetivas. Nao enrole. '
